        ...
        <div className="text-center space-y-6">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-left">
            <p className="text-sm text-gray-700 font-medium">
              ...
              <a href="mailto:partners@planettalk.com" className="text-pt-turquoise underline font-bold">partners@planettalk.com</a>
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="text-center space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-left">
            <p className="text-sm text-blue-800 font-medium">
              ...
              <a href="mailto:partners@planettalk.com" className="underline font-bold">partners@planettalk.com</a>
            </p>
          </div>
          <button
            type="button"
