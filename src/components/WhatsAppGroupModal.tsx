...
const WhatsAppGroupModal = ({ isOpen, onClose, showDontShowAgain = false, onDontShowAgain }: WhatsAppGroupModalProps) => {
  const t = useTranslations('whatsappGroup')
          ...
          {showDontShowAgain && (
            <div className="mb-4">
              <button
                ...
                className="text-sm text-gray-500 hover:text-gray-700 transition-colors flex items-center mx-auto"
              >
