...
const DashboardHeader = ({ onToggleMobileMenu }: DashboardHeaderProps) => {
  ...
  return (
    <header className="bg-white border-b border-gray-200 h-16 flex items-center px-6 w-full overflow-x-hidden">
              ...
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 z-50">
                ...
                <div className="border-t border-gray-100 py-2">
                  <button
                    ...
                    className="flex items-center justify-between w-full px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors duration-200"
                  >
